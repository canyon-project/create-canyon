"use client"
import { Typography, Divider, Avatar, Input, Select, Button, Space, Row, Col } from "antd"
  ...
  return (
    <div style={{ maxWidth: "800px", padding: "24px", margin: "0 auto" }}>
      ...
      <Row align="middle" justify="space-between" style={{ marginBottom: "16px" }}>
        ...
        <Col>
          <Avatar size={80} src="/placeholder.svg?height=80&width=80" style={{ border: "1px solid #f0f0f0" }} />
        </Col>
      </Row>
